...
def chat():
    ...
    if user_input:
        ...
        # TODO: If session contains "history", use that to replace input_messages and add user_input_dict


        # Send to OpenAI API
        result_messages = text_chat(input_messages)
        # TODO: Save message to history for next chat
...
def clear_history():
    # TODO: Remove "history" from the session dictionary
